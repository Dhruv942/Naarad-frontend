...
const LandingPage: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (isEmailValid && isWhatsappValid) {
      try {
        const response = await fetch("https://naaradupdates.info/auth/login", {
          method: "POST",
          headers: {
        ...
        <div className="container mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="text-center lg:text-left">
              <div
                className="flex items-center justify-center lg:justify-start mb-4 wow animate__animated animate__fadeInDown"
                data-wow-delay="0s"
              >
              ...
              <h1
                className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-5 tracking-tight wow animate__animated animate__fadeInDown"
                data-wow-delay="0.2s"
              >
          ...
          <div className="bg-gradient-to-br from-gray-850 to-gray-950 backdrop-blur-lg shadow-2xl-dark rounded-2xl p-8 md:p-12 w-full max-w-lg mx-auto border border-white/10 wow animate__animated animate__fadeInUp">
            ...
            <form onSubmit={handleLogin} className="space-y-7">
              ...
              <Button
                ...
                variant="primary"
                size="lg"
                className="w-full !py-3.5 shadow-lg hover:shadow-glow-primary transform hover:scale-105"
              >
